...
1. ユーザー提出データ
    ...
    - Web Pushサブスクリプションデータ：サブスクリプションエンドポイントを含む。
    - 電子メールアドレス（OAuthログインユーザー任意）：ユーザー個人の電子メールアドレス。
...
| Web Pushサブスクリプションデータ | ユーザー認証 | デスクトッププッシュ通知送信 | Cloudflare D1データベース | |
| 電子メールアドレス | ユーザー入力 | 返信通知の受信 | Cloudflare D1データベース | OAuthログインユーザー任意 |
...
- ユーザーエクスペリエンスの向上：ユーザーのテーマ設定（ライト/ダークモード）をlocalStorageに保するか、電子メールアドレスを使用してメール通知を送信存し、次回アクセス時にパーソナライズされたインターフェース設定を維持できるようにします。未ログインユーザーについては、カスタムニックネームをlocalStorageに保存して後続のコメントで使用できるようにします。
- コミュニケーションと通知：Web Pushサブスクリプションデータを使用してデスクトッププッシュ通知を送信し、コメントへの返信やその他の関連するインタラクション情報をタイムリーにお知らせします。
...
- Cloudflare D1：コメントデータ、OAuthログイン情報、個人ホームページリンク、電子メールアドレス、Web PushサブスクリプションデータはすべてCloudflare D1データベースに保存されます。このデータベースは、暗号化データ保存、アクセス制御、定期バックアップを含むエンタープライズレベルのセキュリティ保護を提供します。すべてのデータ転送は暗号化接続を通じて行われます。
