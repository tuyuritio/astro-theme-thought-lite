...
2. Modify or add variables:
    ...
    | `PUBLIC_VAPID_KEY`* | VAPID public key for desktop push notifications, generate with `pnpx web-push generate-vapid-keys` |
    | `PRIVATE_VAPID_KEY`* | VAPID private key for desktop push notifications, generated along with public key |
