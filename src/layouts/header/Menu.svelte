...
<div class="flex flex-col justify-center border-e pe-2 border-primary sm:relative sm:border-0 sm:p-0 group">
	...
	<div class="pt-1 z-200 bg-background sm:absolute sm:top-full sm:start-1/2 sm:h-max sm:-translate-x-1/2 sm:rtl:translate-x-1/2 sm:opacity-0 sm:invisible sm:transition-[opacity,visibility] sm:group-hover:opacity-100 sm:group-hover:visible">
